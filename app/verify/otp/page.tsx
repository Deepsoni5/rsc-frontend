        ...
        <div className="flex items-center justify-center p-8 bg-[#1032B9]/10 backdrop-blur-sm rounded-2xl">
          <div className="w-full max-w-md space-y-8">
            <div className="space-y-2 text-center">
              ...
              <p className="text-gray-400">Enter the code from the SMS we sent to {phoneNumber}</p>
            </div>
                ...
                {otp.map((digit, index) => (
                  <input
                    ...
                    className={cn(
                      ...
                      activeInput === index ? "border-[#EF3DF6]" : "border-white/20",
                    )}
              ...
              <div className="text-center">
                <div className="text-sm text-gray-400">
                  ...
                  <button
                    ...
                    className={cn(
                      "font-semibold",
                      isResendDisabled ? "text-gray-500 cursor-not-allowed" : "text-[#EF3DF6] hover:text-[#EF3DF6]/80",
                    )}
